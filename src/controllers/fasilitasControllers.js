...
const createFasilitas = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Gagal membuat fasilitas", detail: error.message });
  }
};
...
const editFasilitas = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Gagal mengupdate fasilitas", detail: error.message });
  }
};
...
const deleteFasilitas = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Gagal menghapus fasilitas", detail: error.message });
  }
};
